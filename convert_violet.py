...
CHAPTERS = [
    ...
    (31, "031-chapter-13", 13, "Nairobi", 32, 2),
    ...
    (73, "073-chapter-42", 42, "The Reliquary and the Vial", 78, 4),
    (74, "074-chapter-43", 43, "The Chamber of Harmonic Discord", 79, 4),
    (75, "075-chapter-44", 44, "The Residential Pavilion of Global Serenity", 80, 4),
