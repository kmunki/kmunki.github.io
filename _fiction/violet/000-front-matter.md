...
<article class="front-matter">
    <header class="front-matter-header">
        ...
        <h1 class="page-title">Front Matter</h1>
    </header>
...
<a href="/assets/images/violet/world-map.jpg" target="_blank" class="map-link">
    <img src="/assets/images/violet/world-map.jpg" alt="Map of the World of Violet" />
...
<style>
    ...
    .front-matter-content h2:first-of-type {
        border-top: none;
        margin-top: 0;
        padding-top: 0;
    }

    .front-matter-content h3 {
        font-size: 1.3rem;
        font-weight: 500;
    ...
    .personages-section h2 {
        margin-top: 0 !important;
        padding-top: 0 !important;
        border-top: none !important;
    }

    .personages-section > p:first-of-type {
        font-style: italic;
        color: #666;
        font-size: 0.95rem;
        margin-bottom: 2rem;
    ...
    .personages-section h3:first-of-type {
        border-top: none;
        padding-top: 0;
    }

    /* Character entries */
    .personages-section p {
        margin-bottom: 1.5rem;
        line-height: 1.8;
        padding-left: 1rem;
    ...
    .personages-section p:hover {
        border-left-color: #ccc;
        background: #ffffff;
        padding-left: 1.5rem;
    }

    .personages-section p strong {
        font-weight: 600;
        color: #111;
        font-size: 1.05rem;
        display: block;
    ...
    .front-matter-content table td {
        padding: 0.75rem;
        border-bottom: 1px solid #eee;
        vertical-align: top;
    }

    .front-matter-content table tr:hover {
        background: #fafafa;
    }

    .front-matter-content table td:last-child {
        font-style: italic;
    }
    ...
    @media (max-width: 600px) {
        ...
        /* Make zoom hint always visible on mobile */
        .zoom-hint {
            opacity: 0.9;
            font-size: 0.75rem;
